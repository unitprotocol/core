// test from openzeppelin:3.4.0 for testing ported UnitERC20
// https://github.com/OpenZeppelin/openzeppelin-contracts/blob/release-v3.4/test/token/ERC20/ERC20.test.js
...
const ERC20Mock = artifacts.require('UnitERC20Mock');
const ERC20DecimalsMock = artifacts.require('UnitERC20DecimalsMock');
