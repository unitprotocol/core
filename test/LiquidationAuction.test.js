...
contract('LiquidationAuction', function([
	...
	it('Should liquidate triggered position', async function () {
		...
		expect(usdpLiquidatorBalance).to.be.bignumber.equal(this.INITIAL_USDP_AMOUNT.add(initialLiquidatorUsdpBalance).sub(this.utils.calcBorrowFee(initialLiquidatorUsdpBalance)).sub(repayment));
