...
contract('Parameters', function([
	...
	describe('Optimistic cases', function() {
		...
		it('Should view parameters', async function () {
		    const viewer = await AssetParametersViewer.new(this.vaultManagerParameters.address, this.vaultManagerBorrowFeeParameters.address, this.forceTransferAssetStore.address);
