...
const createDeployment = async function(args) {
    const {deployer, foundation, manager, wtoken, baseBorrowFeePercent, borrowFeeReceiver, withHelpers} = args;
    ...
    if (withHelpers)
        script.push(
            ...
            ['AssetParametersViewer', 'VaultManagerParameters', 'VaultManagerBorrowFeeParameters', 'ForceTransferAssetStore'],
