...
const createDeployment = async function(args) {
    ...
    const script = [
        ...
        ['CDPManager01_Fallback', 'VaultManagerParameters', 'OracleRegistry', 'CDPRegistry', 'VaultManagerBorrowFeeParameters'],
        ['AssetsBooleanParameters', 'VaultParameters', ['0x4bfB2FA13097E5312B19585042FdbF3562dC8676', '0x988AAf8B36173Af7Ad3FEB36EfEc0988Fbd06d07'], [PARAM_FORCE_TRANSFER_ASSET_TO_OWNER_ON_LIQUIDATION, PARAM_FORCE_TRANSFER_ASSET_TO_OWNER_ON_LIQUIDATION]],
