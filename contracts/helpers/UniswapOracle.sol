...
import {USDPLib} from "./USDPLib.sol";
...
contract UniswapOracle {
	...
	function getAccountStorageRoot(address uniswapV2Pair, USDPLib.ProofData memory proofData) public view returns (bytes32 storageRootHash, uint256 blockNumber, uint256 blockTimestamp) {
		bytes32 stateRoot;
	...
	function verifyBlockAndExtractReserveData(IUniswapV2Pair uniswapV2Pair, uint8 minBlocksBack, uint8 maxBlocksBack, bytes32 slotHash, USDPLib.ProofData memory proofData) public view returns
	...
	function getPrice(IUniswapV2Pair uniswapV2Pair, address denominationToken, uint8 minBlocksBack, uint8 maxBlocksBack, USDPLib.ProofData memory proofData) public view returns (uint256 price, uint256 blockNumber) {
	...
	function getPriceRaw(IUniswapV2Pair uniswapV2Pair, bool denominationTokenIs0, uint8 minBlocksBack, uint8 maxBlocksBack, USDPLib.ProofData memory proofData) public view returns (uint256 price, uint256 blockNumber) {
