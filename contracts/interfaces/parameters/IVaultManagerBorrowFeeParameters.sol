...
interface IVaultManagerBorrowFeeParameters {
    ...
    function BORROW_FEE_100_PERCENT() external view returns (uint32);
     ...
     **/
    function setBaseBorrowFee(uint32 newBaseBorrowFee) external;
     ...
     **/
    function setAssetBorrowFee(address asset, bool newEnabled, uint32 newFee) external;
     ...
     **/
    function getBorrowFee(address asset) external view returns (uint32);
}
