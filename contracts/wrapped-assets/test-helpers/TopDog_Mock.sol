...
// Origin contract addr https://etherscan.io/address/0x94235659cf8b805b2c658f9ea2d6d6ddbb17c8d7#code
...
import "./BoneToken_Mock.sol";
import "./BoneLocker_Mock.sol";
...
contract TopDog_Mock is ITopDog, Ownable, ReentrancyGuard {
    ...
    IBoneLocker public override boneLocker;
    // Dev address.
    ...
    uint256 public override rewardMintPercent;
    ...
    function pendingBone(uint256 _pid, address _user) external override view returns (uint256) {
        PoolInfo storage pool = poolInfo[_pid];
    ...
    function boneLockerUpdate(address _boneLocker) public onlyOwner {
        boneLocker = BoneLocker_Mock(_boneLocker);
    }
