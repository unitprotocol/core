...
/**
 * @title VaultManagerChainlinkPoolToken
 **/
contract VaultManagerChainlinkPoolToken is ReentrancyGuard {
    using SafeMath for uint;

    Vault public immutable vault;
    VaultManagerParameters public immutable vaultManagerParameters;
    OracleSimplePoolToken public immutable oracle;
    uint public constant ORACLE_TYPE = 6;
    ...
    **/
     ...
     **/
    constructor(address payable _vaultManagerParameters, address _chainlinkOraclePoolToken) public {
        ...
        oracle = OracleSimplePoolToken(_chainlinkOraclePoolToken);
    }
    ...
    nonReentrant
    {
        ...
        _calculateValueAndEnsureCollateralization(asset, msg.sender);
    ...
    nonReentrant
    {
        ...
        uint colUsdValue_q112 = oracle.oracleMainAsset().assetToUsd(vault.col(), 1);
    ...
    internal
    {
        ...
        _calculateValueAndEnsureCollateralization(asset, user);
    }

    // ensures that borrowed value is in allowed range
    function _calculateValueAndEnsureCollateralization(
        address asset,
        address user
    )
    internal
