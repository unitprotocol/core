...
/**
 * @title ChainlinkOraclePoolToken_Mock
 * @dev Calculates the USD price of desired tokens
 **/
contract ChainlinkOraclePoolToken_Mock is OracleSimplePoolToken {
    using SafeMath for uint;
    uint public immutable Q112 = 2 ** 112;

    constructor(address _chainlinkOracleMainAsset_Mock) public {
        oracleMainAsset = ChainlinkedOracleSimple(_chainlinkOracleMainAsset_Mock);
    }
