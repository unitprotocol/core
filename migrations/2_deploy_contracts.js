...
//   );
//
//   const parametersAddr = calculateAddressAtNonce(this.deployer, await web3.eth.getTransactionCount(this.deployer) + 1);
//   const usdp = await deployer.deploy(USDP, parametersAddr);
//   const vaultAddr = calculateAddressAtNonce(this.deployer, await web3.eth.getTransactionCount(this.deployer) + 1);
...
//   const liquidator = await deployer.deploy(Liquidator, parameters.address, vault.address, uniswapOracle.address, col.address, liquidationSystem);
